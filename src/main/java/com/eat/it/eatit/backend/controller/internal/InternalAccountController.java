...
import com.eat.it.eatit.backend.service.internal.InternalAccountService;
...
@RestController
@RequestMapping("/api/v1/internal/account")
...
public class InternalAccountController {
    ...
    @Autowired
    public InternalAccountController(InternalAccountService accountService) {
    ...
    @PutMapping(value = "/{id}/recipes", consumes = "application/json")
